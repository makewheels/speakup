...
CHAT_FALLBACK_1_API_KEY = os.getenv("CHAT_FALLBACK_1_API_KEY", "")
CHAT_FALLBACK_1_BASE_URL = os.getenv("CHAT_FALLBACK_1_BASE_URL", "")
CHAT_FALLBACK_1_MODEL = os.getenv("CHAT_FALLBACK_1_MODEL", "")
CHAT_FALLBACK_2_API_KEY = os.getenv("CHAT_FALLBACK_2_API_KEY", "")
CHAT_FALLBACK_2_BASE_URL = os.getenv("CHAT_FALLBACK_2_BASE_URL", "")
CHAT_FALLBACK_2_MODEL = os.getenv("CHAT_FALLBACK_2_MODEL", "")
