...
语言：summary 中文≤25字；gap 的 original/better 用英文；title 中文短语；why 中文≤30字；
chinese 是 better 的中文意思和复习提示词，口语化、≤20字。
...
score 是 IELTS speaking 0-9、0.5 步进。summary 中文≤25字；original/better 用英文；
title 中文短语；why 中文≤30字；chinese 是 better 的简短中文意思。
