...
def practice_attempt_id() -> str: return _new_id("pa_")
def review_item_id() -> str: return _new_id("rv_")
def llm_call_id() -> str: return _new_id("llm_")
def feedback_id() -> str: return _new_id("fb_")
def feedback_image_id() -> str: return _new_id("fi_")
def recording_id() -> str: return _new_id("rec_")
def avatar_id() -> str: return _new_id("av_")
def notification_event_id() -> str: return _new_id("nt_")
